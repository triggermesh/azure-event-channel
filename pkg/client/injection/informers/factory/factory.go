...
import (
	...
	externalversions "github.com/triggermesh/azure-event-channel/pkg/client/informers/externalversions"
	client "github.com/triggermesh/azure-event-channel/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/azure-event-channel/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
