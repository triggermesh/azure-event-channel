...
import (
	...
	internalclientsetscheme "github.com/triggermesh/azure-event-channel/pkg/client/clientset/internalclientset/scheme"
	injectionclient "github.com/triggermesh/azure-event-channel/pkg/client/injection/client"
	azurechannel "github.com/triggermesh/azure-event-channel/pkg/client/injection/informers/messaging/v1alpha1/azurechannel"
...
const (
	defaultControllerAgentName = "azurechannel-controller"
	defaultFinalizerName       = "azurechannels.messaging.triggermesh.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:        azurechannelInformer.Lister(),
		Recorder:      recorder,
		reconciler:    r,
