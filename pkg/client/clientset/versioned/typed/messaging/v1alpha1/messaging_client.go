...
import (
	...
	"github.com/triggermesh/azure-event-channel/pkg/client/clientset/versioned/scheme"
...
func (c *MessagingV1alpha1Client) AzureChannels(namespace string) AzureChannelInterface {
	return newAzureChannels(c, namespace)
}
