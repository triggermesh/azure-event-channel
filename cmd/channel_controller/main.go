...
import (
	...
	azurechannel "github.com/triggermesh/azure-event-channel/pkg/reconciler/controller"
	"go.uber.org/zap"
...
const (
	dispatcherDeploymentName = "azure-ch-dispatcher"
	dispatcherServiceName    = "azure-ch-dispatcher"
)
...
func main() {
	...
	//TODO Add check the connection with Azure stream

	logger = logger.With(zap.String("controller/impl", "pkg"))
	logger.Info("Starting the Azure controller")
	...
	messagingInformerFactory := informers.NewSharedInformerFactory(opt.AzureClientSet, opt.ResyncPeriod)
